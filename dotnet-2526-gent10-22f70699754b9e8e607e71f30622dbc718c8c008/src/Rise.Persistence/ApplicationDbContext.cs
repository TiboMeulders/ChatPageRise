...
using Rise.Domain.Entities;//F-api
...
public class ApplicationDbContext(DbContextOptions<ApplicationDbContext> opts) : IdentityDbContext<IdentityUser>(opts)
{
    ...
    // public DbSet<FriendRequest> FriendRequests => Set<FriendRequest>();//F-api
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        // <-- You can add entity-specific configuration here
        modelBuilder.Entity<FriendRequest>(entity =>
        {
            entity.HasKey(f => new { f.UserId1, f.UserId2 });
            entity.Property(f => f.UserId1).HasColumnName("user_id1");
            entity.Property(f => f.UserId2).HasColumnName("user_id2");
            entity.Property(f => f.accepted).HasDefaultValue(false);
            entity.Property(f => f.blocked).HasDefaultValue(false);
        });
    }
