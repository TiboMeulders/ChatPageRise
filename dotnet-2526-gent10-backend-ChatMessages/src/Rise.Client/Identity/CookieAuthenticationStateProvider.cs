...
namespace Rise.Client.Identity
{
    ...
    public class CookieAuthenticationStateProvider(IHttpClientFactory httpClientFactory): AuthenticationStateProvider, IAccountManager
    {
        ...
        /// </returns>
        public async Task<Result> RegisterAsync(AccountRequest.Register model)
        {
            try
            {
                var response = await httpClient.PostAsJsonAsync("/api/identity/accounts/register", model);
